...
Font.register({family: 'Bangla Bold', fontWeight: 'normal', src: Suttony_MJ_Bold});
Font.register({family: 'Bangla', fontWeight: 'normal', src: Suttony_MJ});
Font.register({family: 'Bangla Bold 2', fontWeight: 'normal', src: AdorshoLipi_Bold});
...
export default function OfficeOrderCopy(props){
    ...
    const style_butt = StyleSheet.create({
        download_butt:{
            ...
            textAlign: "center",
            border: orc_hover ? "2px solid white" : "2px solid #3f8ba8",
            borderRadius: "20pt",
            backgroundColor: orc_hover ? "#3f8ba8" : "white",
            color: orc_hover ? "white" : "#3f8ba8",
                ...
                <View style={style_orc.off_ord}>
                    ...
                    <View style={style_orc.or_text_box}>
                        <Text style={style_orc.or_text_2}>
                            গৃহনির্মাণ ঋণ দানের নিয়মানুযায়ী ১ নং ক্রমিকে বর্ণিত আপনার নামে উল্লিখিত অর্থ ঋণ হিসাবে নিম্নে বর্ণিত শর্তে এতদ্বারা মঞ্জুর করা হইল।
                        </Text>
                    </View>
                    ...
                    <View style={style_orc.or_text_box}>
                        ...
                        <Text style={style_orc.or_text_2}>
                            ১ । বিশ্ববিদ্যালয়ের শিক্ষক, কর্মকর্তা/কর্মচারীদের গৃহনির্মাণ সামগ্রী ক্রয়ের জন্য।
                        </Text>
                        <Text style={style_orc.or_text_2}>
                            ২ । ঋণগ্রহীতার পেনশন, প্রভিডেন্ট ফান্ড, গ্রুপ ইন্সুরেন্স ও অন্যান্য পাওনা টাকা হইতে আদায়যোগ্য হইবে। । 
                        </Text>
                        <Text style={style_orc.or_text_2}>
                            ৩ । বার্ষিক ৪.৭৫% সরল সুদ আরোপ ও আদায়যোগ্য। । 
                        </Text>
                        <Text style={style_orc.or_text_2}>
                            ৪ । ঋণগ্রহীতার মাসিক বেতন হতে বিরতিহীনভাবে ঋণের টাকা আদায় করা হইবে।
                        </Text>
                        <Text style={style_orc.or_text_2}>
                            ৫ । ঋণের টাকা সুদসহ সর্বোচ্চ ১০০ কিস্তিতে আদায় করা হইবে।।
                        </Text>
                        <Text style={style_orc.or_text_2}>
                            ৬ । ঋণের টাকার মাসিক কর্তন কোন অবস্থাতেই বন্ধ করা যাবে না ও ঋণ আদায় বন্ধ করার জন্য কোন দরখাস্ত বিবেচনা করা হবে না। । 
                        </Text>
                        <Text style={style_orc.or_text_2}>
                            ৭ । ঋণ পরিশোধের পূর্বে ঋণ গ্রহীতা যদি মৃত্যুবরণ বা চাকুরী হতে অবসর গ্রহণ করেন তবে ঋণের অবশিষ্ট টাকা সুদসহ তাঁর পেনশন, প্রভিডেন্ট ফান্ড, গ্রুপ ইন্সুরেন্স ও অন্যান্য পাওনা টাকা হইতে আদায় করা হবে।।
                        </Text>
                        <Text style={style_orc.or_text_2}>
                            ৮ । ৩০০/- (তিনশত) টাকার নন জুডিশিয়াল স্ট্যাম্পে চুক্তি পত্র সম্পাদন করিতে হইবে।
                        </Text>
                        <Text style={style_orc.or_text_2}>
                    ...
                    <View style={[style_orc.or_text_box, style_orc.or_text_box_2]}>
                    ...
                    <View style={style_orc.or_text_box}>
                        <Text style={style_orc.or_text_2}>
                            অবগতি ও প্রয়োজনীয় ব্যবস্থা গ্রহণের জন্য অনুলিপি প্রেরিত হইলঃ। 
                        </Text>
                    </View>
    ...
    return(
        ...
        <>
            ...
            <div style={style_butt.download_butt} onClick={onORCClick} onMouseEnter={() => setOrc_hover(true)} onMouseLeave={() => setOrc_hover(false)}>
                Office Order Copy
            </div>
