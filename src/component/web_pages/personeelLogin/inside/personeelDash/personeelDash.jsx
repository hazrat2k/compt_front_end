      ...
      pd_sanced_loan_display.push(
        <div className="pd_section_row">
          <div
            ...
            onClick={(e) => onSancedLoanIdClick(e, pd_sanced_loan_data[i])}
          >
            <div className="pd_section_col_value">
    ...
    if (pd_userName === loan_personnel[billed_status]) {
      ...
      pd_billed_loan_display.push(
        <div className="pd_section_row">
          <div
            className="pd_section_col linked_col pd_section_li_col"
            onClick={(e) => onBilledLoanIdClick(e, pd_billed_loan_data[i])}
          >
            <div className="pd_section_col_value">
    ...
    <>
      ...
      <div className="personnel_dashboard">
        ...
        <div className="pd_section">
          <div className="pd_section_label">Personal Information :</div>
        ...
        {pd_select == "null" ? (
          <div className="no_pending_loan">Select a Loan Type to Display</div>
        ) : (
          <>
            {pd_userName === "accntt_fund" ? (
              <div className="pd_section">
                <div className="pd_section_label">Preview Copy :</div>
              ...
              <>
                <div className="pd_section">
                  <div className="pd_section_label">Sanctioned Loan :</div>
                  {sanctioned_loan_status ? (
                    <div className="pd_section_items pending_loan">
                      <div className="pd_section_row pd_section_head_row">
                        <div className="pd_section_col pd_section_li_col">
                          <div className="pd_section_col_value">LOAN ID</div>
                        </div>
                        <div className="pd_section_col pd_section_col_wid">
                          <div className="pd_section_col_value">LOAN TYPE</div>
                        </div>
                        <div className="pd_section_col pd_section_col_wid">
                          <div className="pd_section_col_value">
                            APPLICATION STATUS
                    ...
                    <div className="no_pending_loan">No Sanctioned Loan</div>
                  )}
                </div>

                <div className="pd_section">
                  <div className="pd_section_label">Billed Loan :</div>
                  {billed_loan_status ? (
                    <div className="pd_section_items pending_loan">
                      <div className="pd_section_row pd_section_head_row">
                        <div className="pd_section_col pd_section_li_col">
                        ...
                        <div className="pd_section_col pd_section_col_wid">
                          <div className="pd_section_col_value">BILL DATE</div>
                        </div>
                      </div>
                    ...
                    <div className="no_pending_loan">No Billed Loan</div>
                  )}
                </div>
              </>
            )}
            ...
            <div className="pd_section">
              <div className="pd_section_label">Pending Loan :</div>
              ...
              {pending_loan_status ? (
                <div className="pd_section_items pending_loan">
                  <div className="pd_section_row pd_section_head_row">
                    ...
                    <div className="pd_section_col pd_section_col_wid">
                      <div className="pd_section_col_value">APPLICANT NAME</div>
                    </div>
                    <div className="pd_section_col pd_section_col_wid">
                      <div className="pd_section_col_value">DESIGNATION</div>
                    </div>
                    <div className="pd_section_col pd_section_col_wid">
                      <div className="pd_section_col_value">OFFICE/DEPT.</div>
                    </div>
                    <div className="pd_section_col pd_section_col_wid">
                      <div className="pd_section_col_value">LOAN TYPE</div>
                    </div>
                    ...
                    <div className="pd_section_col pd_section_col_wid">
                      <div className="pd_section_col_value">APPLIED TIME</div>
                    </div>
                  </div>
                ...
                <div className="no_pending_loan">No Pending Loan</div>
              )}
            </div>

            <div className="pd_section">
              <div className="pd_section_label">Processing Loan :</div>
              ...
              {processing_loan_status ? (
                ...
                <div className="no_pending_loan">No Processing Loan</div>
              )}
            </div>
          </>
        )}
