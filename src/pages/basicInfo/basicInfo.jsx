...
import DataCheckBoxField from "../../component/loan_apply/dataCheckBoxField/dataCheckBoxField";
...
export default function BasicInfo() {
    ...
    const [accountNo, setAccountNo] = useState(
        "44040" + basic_data["BANK_ACCOUNT_NO"]
    );
        ...
        <div>
            ...
            <div className="basicField">
                ...
                <DataCheckBoxField
                    ...
                    items={[
                        [
                            "মোটরযান ক্রয়/গৃহ নির্মাণ/মেরামত/জমি ক্রয় ঋণ",
                            "ভোগ্যপণ্য ঋণ",
                            "ল্যাপটপ ঋণ",
                        ...
                        [
                            ...
                            "CONSUMER LOAN",
                            "LAPTOP LOAN",
                            "SONALI HOUSE BUILDING LOAN",
                            "SONALI ANY PURPOSE LOAN",
                        ],
                    ]}
                    value={loanType}
                    setValue={(data) => {
