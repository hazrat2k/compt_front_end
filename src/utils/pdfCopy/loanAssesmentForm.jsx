    ...
    const sectionItem = (index, label, value) => {
        return(
            <View style={style_laf.section_item}>
                ...
                <Text style={[style_laf.section_item_colon, style_laf.sec_item_def]}>.</Text>
                <Text style={[style_laf.section_item_label, style_laf.sec_item_def]}>{label}</Text>
                <Text style={[style_laf.section_item_colon, style_laf.sec_item_def]}>:</Text>
    ...
    const MyForm = (
        ...
        <Document>
                    ...
                    <View style={style_laf.assessment_section}>
                        ...
                        <View style={style_laf.section_items}>
                            <View style={style_laf.section_items_div}>
                                {sectionItem("1", "Joining Date", laf_joining_date)}
                                {sectionItem("3", "Maturity of Service (including PRL)", laf_mos)}
                            </View>

                            <View style={style_laf.section_items_div}>
                                {sectionItem("2", "Service Length (Year)", laf_serv_len_y)}
                                {sectionItem("4", "Remaining Service (No of Month)", laf_rem_serv_m)}
                            </View>
            ...
            <Page size="A4" orientation="portrait">
                ...
                <View style={style_laf.assessment_section}>
                    <Text style={[style_laf.subsection_label, {fontFamily: "English Bold"}]}>
                        AUDIT OFFICE
                    </Text>
                    <View style={style_laf.write_signature}>
